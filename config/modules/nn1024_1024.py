...
weight_file_name = 'nn1024_1024_weights.pkl'
log_file_name = 'nn1024_1024.log'
...
def create_weights(number_input, number_output, logger):
    ...
    if os.path.isfile(weight_file_name):
        ...
        weights = {
            ...
            'w_2': base.weight_variable([1024,1024]),
            'b_2': base.bias_variable([1024]),

            'w_3': base.weight_variable([1024,number_output]),
